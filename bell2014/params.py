...
class IntrinsicParameters():
    ...
    def __init__(self):
        """ Parameters relevant to our ICCV'15 paper """
        ...
        #: chromaticity.
        self.chromaticity_weight = 100.0

        #: which norm is used for chromaticity
        self.chromaticity_norm = "L1"

        #: weight of the learned relative prior
        self.learned_prior_weight = 10000.0

        #: hinge loss offset for the learned prior
        self.hinge_offset = 0.4

        #: if True, keep the median of all intensities fixed in stage 2.
        ...
        """ Below are additional parameters used by Bell et al. (SIGGRAPH'14).
        All numerical values are set to zero in this release. See the original
        code by Bell et al. if you'd like to turn on some of the 
        ...
        self.shading_blur_sigma = 0

        #: exponent by which the blur size decreases each iteration
        self.shading_blur_iteration_pow = 0
